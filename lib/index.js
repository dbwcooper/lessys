...
__export(exports, {
  ...
  generateOneLess: () => generateOneLess,
  getCommonTheme: () => getCommonTheme,
  getSingleTheme: () => getSingleTheme,
  getThemeVariables: () => getThemeVariables,
  main: () => main,
  transferComponentLess: () => transferComponentLess
});
...
var import_gulp = __toModule(require("gulp"));
var import_gulp_concat = __toModule(require("gulp-concat"));
